...
class AnonymiseraIntygForSRS {
    ...
    static final List<String> headers = [
            ...
            "aktivitet.KontaktArbetsformedling", "aktivitet.kontaktForetagsVard", "aktivitet.Ovrigt",
            "aktivitet.planeradPagaendeAtgardSjukvard", "aktivitet.planeradPagaendeAnnanAtgard",
            "aktivitet.arbetslivsinriktadRehabAktuell", "aktivitet.arbetslivsinriktadRehabEjAktuell", "aktivitet.garEjBedommaOmArbetslivsinriktadRehabAktuell",
            "aktivitet.forandrattRessattAktuellt", "aktivitet.forandrattRessattEjAktuellt", "aktivitet.kontaktMedForsakringskassanAktuellt",
            "medicinskttillstand.Diagnoskod",
            "funktionstillstand.kroppsfunktion", "funktionstillstand.prognosangivelse",
            "arbetsformaga.nedsattningsgrad.1/4.from", "arbetsformaga.nedsattningsgrad.1/4.tom",
            "arbetsformaga.nedsattningsgrad.1/2.from", "arbetsformaga.nedsattningsgrad.1/2.tom",
            "arbetsformaga.nedsattningsgrad.3/4.from", "arbetsformaga.nedsattningsgrad.3/4.tom",
            "arbetsformaga.nedsattningsgrad.helt.from", "arbetsformaga.nedsattningsgrad.helt.tom",
            "sysselsattning.nuvarandeArbete", "sysselsattning.arbetsloshet", "sysselsattning.foraldrarledighet"
    ]
    ...
    static void main(String[] args) {
        ...
        AnonymiseraXmlForSRS anonymiseraXml = new AnonymiseraXmlForSRS(anonymiseraPersonId, anonymiseraHsaId, anonymiseraDatum)
    ...
    static void processXml(String xml, String age, String sex) throws ParserConfigurationException, SAXException, IOException,
        ...
        rowMaker.add(makeRow(Arrays.asList(
                ...
                aktivitetSmittskydd,
                aktivitetKontaktMedArbetsformedling, aktivitetKontaktForetagsvard, aktivitetOvrigt,
                aktivitetPlaneradPagaendeAtgardSjukvard, aktivitetPlaneradPagaendeAnnanAtgard,
                aktivitetRehabAktuell, aktivitetRehabEjAktuell, aktivitetRehabEjBedomma,
                aktivitetRessattAktuell, aktivitetRessattEjAktuell, aktivitetKontaktMedFk,
                medicinskttillstandDiagnoskod, funktionstillstandTyp, funktionstillstandPrognos,
                ...
                nuvarandeArbete, arbetsloshet, foraldrarledighet
        )))
