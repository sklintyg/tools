...
import se.inera.intyg.tools.SkickaIntygSentTillIntygsstatistik
import org.junit.*
import static groovy.test.GroovyAssert.*

class SkickaIntygSentTillIntygsstatistikTest extends GroovyTestCase {


    @Test
    public void testParseArgumentsWithoutLoadingPropertiesFromFile() {
        def testee = new SkickaIntygSentTillIntygsstatistik()
    ...
    public void testParseArgumentsWhenOnlyDefaultPropertiesAreLoaded() {
        def testee = new SkickaIntygSentTillIntygsstatistik("app.properties")
